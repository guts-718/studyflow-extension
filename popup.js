...
async function initNotes() {
    ...
    fileInput.onchange = async () => {
        ...
        console.log("checking if note exists for this file: ", file);
        if (!file) return;

        // persist active file for this page
        await bgRequest({
        ...
        console.log("checking if note exists for this file: ",file, "note", note);
